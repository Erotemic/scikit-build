...
class CMaker(object):
    ...
    CommandLine:
        xdoctest -m ~/code/scikit-build/skbuild/cmaker.py CMaker

    Example:
        >>> from skbuild.cmaker import *  # NOQA
        >>> # Setup dummy repo
        >>> import ubelt as ub
    ...
    def get_python_version():
        ...
        Example:
            ...
            >>> python_version = CMaker.get_python_version()
            >>> print('python_version = {!r}'.format(python_version)) # xdoc: +IGNORE_WANT
            python_version = '3.7'
        """
    ...
    def get_python_include_dir(python_version):
        ...
        Example:
            ...
            >>> python_version = CMaker.get_python_version()
            >>> python_include_dir = CMaker.get_python_include_dir(python_version)
            >>> print('python_include_dir = {!r}'.format(python_include_dir)) # xdoc: +IGNORE_WANT
    ...
    def get_python_library(python_version):
        ...
        Example:
            ...
            >>> print('python_library = {!r}'.format(python_library))  # xdoc: +IGNORE_WANT
